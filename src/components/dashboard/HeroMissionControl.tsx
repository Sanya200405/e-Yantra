...
export function HeroMissionControl({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-950 via-indigo-950 to-blue-950 text-white border border-blue-500/30 shadow-2xl p-6 sm:p-8">
      {/* Background Circuit Grid & Colored Ambient Glows */}
      ...
      <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-violet-600/15 rounded-full blur-3xl pointer-events-none" />

      {/* Top Telemetry Header Bar */}
      <div className="relative z-10 flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-indigo-800/60 text-xs">
        <div className="flex items-center gap-3">
          <span
            className={`inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full font-mono text-xs font-bold tracking-wide border ${
              hasData
          ...
          <span className="hidden sm:inline font-mono text-slate-300 text-xs">
            SYS://EYRC-MISSION-CONTROL • {topSection?.competitionStage || 'Registration Phase'}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700 text-slate-200 hover:text-white text-xs font-mono font-medium transition-all"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-linear-to-r from-orange-600 via-amber-600 to-orange-500 hover:from-orange-500 hover:to-amber-500 text-white text-xs font-bold shadow-neon-orange transition-all active:scale-95"
          >
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-orange-400 uppercase tracking-wider">
            ...
            <p className="text-sm sm:text-base text-slate-200 max-w-xl leading-relaxed">
              ...
              {hasData
                ? ` Real-time telemetry, robotics simulation roadmap, hardware logs, and mission velocity for your eYRC project.`
                : ` Workspace ready. Add competition tasks, meeting agendas, and hardware components to begin tracking team velocity.`}
            </p>
          </div>

          {/* Key Mission Metrics Badges */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
            <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-700/80 backdrop-blur-md">
            ...
            <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-700/80 backdrop-blur-md col-span-2 sm:col-span-1">
              <span className="text-[11px] font-mono text-slate-400 block uppercase font-medium">
                Next Meeting / Class
              </span>
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center p-6 rounded-2xl bg-indigo-950/60 border border-indigo-700/50 backdrop-blur-md relative overflow-hidden">
          ...
          <div className="relative w-full max-w-[280px] h-36 flex items-center justify-center">
            ...
            >
              {/* Ground Grid lines */}
              <line x1="20" y1="140" x2="280" y2="140" stroke="#475569" strokeWidth="1.5" strokeDasharray="4 4" />
              <line x1="40" y1="150" x2="260" y2="150" stroke="#334155" strokeWidth="1" />
          ...
          <div className="w-full pt-3 space-y-2">
            ...
            <div className="w-full h-3 rounded-full bg-slate-900 border border-slate-700 p-0.5 overflow-hidden">
              <div
                className="h-full rounded-full bg-linear-to-r from-blue-500 via-cyan-400 to-emerald-400 transition-all duration-1000 ease-out shadow-[0_0_12px_rgba(6,182,212,0.6)]"
